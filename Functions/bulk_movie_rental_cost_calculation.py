...
def calculate_rental_batch(
    ...
    """
    Эта функция рассчитывает стоимость аренды дисков
    и определяет, превышен ли лимит

    Args:
        quantity(int): Количество арендованных дисков
        rental_rate:(float) Стоимость аренды одного диска
        discount(float): Размер скидки в процентах

    Returns:
        tuple: Кортеж из суммы и булевого значения
        указывающего, укладывается ли в лимит количество дисков
    """
